...
namespace PathFinder.Algorithm_Test.DLite_Heap
{
    class Maze
    {
        ...
        public Point Printed_maze_size()
        {
            return new Point(50 * (this.size_x + 1), 50 * (this.size_y + 1));
        }
        ...
        private void Update_cell(Node paramNode)
        {
            ...
            if (paramNode.g != paramNode.rhs)
                this.u.Insert(paramNode);
        }

        public bool Execution_end()
        {
            return (this.u.Size()==0) || (this.start == (Node)this.u.Peek()) && (this.start.g == this.start.rhs);
        }
        ...
        public void Calculate_path(bool parambool)
        {
            while (!Execution_end())
            {
                ...
                //this.u.remove(localKey);
                //Node localNode = (Node)this.u.Peek();
                //this.u.Delete(this.u.Peek());
                Node localNode = (Node)this.u.Pop();
        ...
        public void Move(bool parambool)
        {
            ...
            if (j != 0)
            {
                ...
                BinaryHeap localTreeSet = new BinaryHeap(size_x * size_y);
                ...
                while (this.u.Size() > 0)
                {
                    ...
                    localNode2 = (Node)this.u.Pop();
                    localTreeSet.Insert(localNode2);
                }
                this.u = localTreeSet;
